...
-- Para valores numéricos
SELECT * FROM "produtos" WHERE "preco" BETWEEN 22000 AND 30000;

-- Para datas
SELECT * FROM "produtos" WHERE "criado" BETWEEN '2048-06' AND '2049-06';

-- também é possível selecionar os que NÃO estão entre esses números passados:
...
SELECT * FROM "produtos" WHERE "categoria" IN ('periferico', 'hardware');

SELECT * FROM "produtos" WHERE "categoria" NOT IN ('periferico', 'hardware');

SELECT * FROM "produtos" WHERE "id" IN ('4', '7', '2');