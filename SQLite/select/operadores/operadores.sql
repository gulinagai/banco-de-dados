...
/*
    ...
    Alguns operadores disponíveis são:
...
-- Posso fazer operações matemáticas depois do where:
SELECT * FROM "produtos" WHERE ("preco" + "taxa_importacao") < 40000;
SELECT * FROM "produtos" WHERE "id" = 3;


SELECT * FROM "produtos" WHERE "preco" > 150000;

/*
Datas
O SQLite permite comparar datas diretamente, desde que estejam no formato correto (geralmente YYYY-MM-DD ou YYYY-MM-DD HH:MM:SS).

*/

SELECT * FROM "produtos" WHERE "criado" > '2049-12'
...
SELECT "nome", "criado" FROM "produtos" WHERE "criado" > '2049-08-3'; -- errado



/*

COLLATE NOCASE no SELECT:

Em textos a comparação é sensível a maiúsculas e minúsculas, a menos que seja especificado o contrário com o COLLATE NOCASE.

*/

SELECT * FROM "produtos" WHERE "nome" = 'Headset ANC Pro';

SELECT * FROM "produtos" WHERE "nome" = 'HeADSET ANC pro' COLLATE NOCASE;

/*

IS e IS NOT 

verifica se é ou não. Serve para null ou valor booleano (0 ou 1)
...
SELECT * FROM "produtos" WHERE "categoria" = NULL; -- errado, dá erro

SELECT * FROM "produtos" WHERE "lancamento" IS TRUE; -- onde lancamento = 1
SELECT * FROM "produtos" WHERE "lancamento" IS FALSE; -- onde lancamento = 0
